	...
	<div class="card-body">
		...
		<form method="post" action="{{ route('barang.update', $data->id_barang) }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="merk_barang" name="merk_barang" value="{{ $data->merk_barang }}">
            </div>
            <div class="mb-3">
                <label for="jenis_barang" class="form-label">Jenis Barang</label>
                <input type="text" class="form-control" id="jenis_barang" name="jenis_barang" value="{{ $data->jenis_barang }}">
            </div>
            <div class="mb-3">
